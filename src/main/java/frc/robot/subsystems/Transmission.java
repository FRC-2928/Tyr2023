...
public class Transmission extends SubsystemBase {
  ...
  public static int shifterSolenoid = 0; // Tyr
  ...
  public Transmission() {
    ...
    m_shiftPiston = new Solenoid(PneumaticsModuleType.CTREPCM, shifterSolenoid); // Tyr 
             // new Solenoid(PneumaticsModuleType.CTREPCM, Constants.PneumaticIDs.kDrivetrainShiftSolenoid);
